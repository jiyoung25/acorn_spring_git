...
CREATE TABLE board_cafe_comment
    ...
    writer VARCHAR2(100),-- 댓글 작성자 id
    content VARCHAR(500),-- 댓글 내용
    target_id VARCHAR2(100),-- 댓글의 대상자 아이디
    ref_group NUMBER, -- 원글의 글번호
    comment_group NUMBER, -- 댓글의 글번호 (대댓을 위한 것)
    deleted CHAR(3) DEFAULT 'no', -- 댓글을 삭제하면 화면상 표시만 안해주게 만들기 위해서 만듦.
    regdate DATE
);
