...
<body>
	<div class="container">
		<h3>UPDATE FORM</h3>
		<form action="update?num=${dto.num }" id="updateForm" method="post">
			<div>
			...
			<div>
				...
				<textarea type="text" name="content" id="content" >${dto.content }</textarea>
			</div>
			<button type="submit" obclick="submitContents(this)">수정</button>
			<button type = "reset">내용 되돌리기</button>
		</form>
	</div>
	<%--
 ...
 --%>
	...
	<script>
		...
		document.querySelector("#updateForm").addEventListener(
				"submit",
				function(e) {
