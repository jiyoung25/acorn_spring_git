...
<head>
<meta charset="UTF-8">
<title>/views/cafe/insertform</title>
</head>
<body>
	<div class="container">
		<h3>INSERT FORM</h3>
		<form action="insert" id="insertForm" method = "post">
			...
			<div>
				...
				<input type="text" name="writer" id="writer" value = "${sessionScope.id }" disabled />
			</div>
			<div>
			...
			<button type="submit" onclick = "submitContents(this)">제출</button>
		</form>
	</div>
	<%--
